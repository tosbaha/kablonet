...
/**
 * POST /KullaniciService.svc/sorgMusteriKotaDonem
 *
...
module.exports = function (req, res) {
  ...
  res.statusCode = 200;
  const mocString = JSON.stringify(require('../fixtures/kotadonem'));
  ...
  res.setHeader("date", "Fri, 23 Feb 2018 19:04:56 GMT");
