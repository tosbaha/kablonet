...
describe('Kablonet Mocking API Test',function() {
    ...
    kablonet.baseUrl = 'http://localhost:' + String(proxyPort);
    ...
    it('should login',async function() {
        ...
        String(result.sonucMusteriAuth[0].MusteriID).should.be.eql('1234567');
